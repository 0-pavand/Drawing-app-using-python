...
pygame.display.set_caption("My paint game !")
...
def draw_menu(size , color):
    ...
    yelllow=pygame.draw.rect(screen,(255,255,0),[WIDTH-60,35,25,25])
    ...
    color_rect=[blue,red,green,yelllow,teal,purple,white,black]
